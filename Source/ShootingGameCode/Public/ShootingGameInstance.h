...
public:
	...
	*/
	...
	void StartOnlineGame(int MaxPlayerNum, bool bIsLAN);
...
public:
	...
	void OnUpdateSessionResult(const TArray<FBlueprintSessionResult>& SessionResult);

	void OnUpdateSessionResult_Implementation(const TArray<FBlueprintSessionResult>& SessionResult);
